...
| count-led or position-led opener ("one field set with three writers", "six write behaviours in one 32-bit word", "the second of the three writers") | open on what the thing is for and what it is, in words a reader with no context can follow; give the count after that, if it still earns its place | PAGE-08 |
