...
> Was: none at the split — the retired registry (7r-adjudications.md) held no plots-owned entries; created empty so every rule directory carries its waivers file.
