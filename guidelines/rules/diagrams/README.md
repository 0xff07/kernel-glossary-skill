...
```
grep -rnE '(BAN|PAGE|FACT|PLOT|DIAG|ROUTINE|PIPELINE)-[0-9]|routines/|pipelines/|WAIVERS' diagrams/DIAG-[0-9]*.md | awk -F: '$2+0 != 1'
grep -rnE '(BAN|PAGE|FACT|PLOT|ROUTINE|PIPELINE)-[0-9]|routines/|pipelines/' diagrams/DIAG-WAIVERS.md
```
