# DIAG-WAIVERS: Waivers and settled rulings for diagrams/

> Was: none at the split — the retired registry (7r-adjudications.md; ledger in tests/TEST-08.md) held no diagrams-owned entries; created empty so every rule directory carries its waivers file.
