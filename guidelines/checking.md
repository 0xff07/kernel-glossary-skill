...
4. [steps.counts] Counts. Re-derive every count and every only, never, always or exactly claim on a differently shaped basis; persist both bases and the reconciled result as a row of the dossier's Bases table (dossier.md [evidence.bases]). The published sentence states the result and its scope and never the search.
