...
The worksheet's sections and what each must hold are worksheet.md, whose own rules check the HEADER, the LINKS table, PARITY, EVIDENCE and the LINT record.
