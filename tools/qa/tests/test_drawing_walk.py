"""kind: rule — the paragraph after a DETAILS figure with a legend links every legend function, in mark order; a lead or SUMMARY figure is left alone."""
import unittest
...
class Walk(unittest.TestCase):
    def test_a_walk_in_mark_order_passes(self):
        ...
        self.assertEqual(found.footer, 'figures-with-legend=1 walked=1 missing-names=0 out-of-order=0')
    ...
    def test_a_lead_figure_is_left_alone(self):
        ...
        self.assertEqual(found.findings, [])
        self.assertEqual(found.footer, 'figures-with-legend=0 walked=0 missing-names=0 out-of-order=0')
