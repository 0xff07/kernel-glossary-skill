...
Files prefixed `page-` are sample pages: each met every gate in SKILL.md and passed `scripts/verify_page.py` with zero findings against its kernel tree. They are the standard to calibrate against when writing any new page, for any subsystem.
