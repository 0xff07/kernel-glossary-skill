...
- Campaign short name: `numa`. Workspace: the campaign file `campaigns/numa.md` plus the artifact directory `progress/numa/` (the per-page worksheets, `<slug>.worksheet.md`, land there and nothing else; parity, lint, and verify records are sections of each worksheet).
