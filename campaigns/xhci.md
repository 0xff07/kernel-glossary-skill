...
Campaign short name: `xhci`. Campaign file: `campaigns/xhci.md`; artifact directory: `progress/xhci/` (worksheets, lint/verify reports, parity tables, and other agent intermediates land there; nothing outside it).
